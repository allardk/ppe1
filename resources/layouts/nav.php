...
<nav class="navbar navbar-toggleable-md navbar-light fixed-top bg-faded">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="hidden-xs-down hidden-sm-down hidden-md-down form-inline mt-2 mt-md-0">
            <input id="email" name="email" required class="form-control mr-sm-2" type="email" placeholder="Newsletter">
